...
const UserSchema = new mongoose.Schema({
  ...
  frozenBalance: { type: Number, default: 0 },   // 新增：冻结余额
...
app.post('/api/init', async (req, res) => {
  ...
  const user1 = await User.create({ username: 'xiaoming', password: '123456', nickname: '小明', phone: '13800000001', balance: 188, credit: 85, idCardVerified: true });
  const user2 = await User.create({ username: 'hong', password: '123456', nickname: '小红', phone: '13800000002', balance: 95, credit: 72, idCardVerified: false });
